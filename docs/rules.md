...
6. **Problemy z dokumentacją:** Jeśli masz problem z biblioteką lub frameworkiem, zawsze sprawdź aktualną dokumentację przy pomocy skilla `/context-mcp`.
...
10. **Zawsze twórz kod i komentarze w języku polskim.**
